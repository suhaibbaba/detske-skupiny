...
} from "@/sanity/queries/breadcrumb";
import { groupPageQuery } from "@/sanity/queries/groups";
import { pageByTypeQuery } from "@/sanity/queries/page";
import { countryQuery, regionQuery } from "@/sanity/queries/school-filter";
import {
  schoolCardsQuery,
  schoolMarkersQuery,
  schoolOrderQuery,

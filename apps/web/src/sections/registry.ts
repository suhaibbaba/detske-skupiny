...
import LatestSchoolCollection from "@/features/home/components/LatestSchoolCollection";
...
import SectionWorthIt from "@/features/cooperation/components/SectionWorthIt";
import PortalsOffered from "@/features/cooperation/components/PortalsOffered";
import OurPricing from "@/features/cooperation/components/OurPricing";
import ListOfSchools from "@/features/cooperation/components/ListOfSchools";
import MapCollection from "@/features/home/components/MapCollection";
...
} satisfies Partial<Record<PageSection["_type"], React.ComponentType<never>>>;
